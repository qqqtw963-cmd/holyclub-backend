...
class PrayerJournalListAPITest(APITestCase):
    MODEL = PrayerJournal
    PATH = "/v1/prayer_journal/"
...
class PrayerJournalCreateAPITest(APITestCase):
    MODEL = PrayerJournal
    PATH = "/v1/prayer_journal/"
...
class PrayerJournalRetrieveAPITest(APITestCase):
    MODEL = PrayerJournal
    PATH = "/v1/prayer_journal/{id}/"
...
class PrayerJournalUpdateAPITest(APITestCase):
    MODEL = PrayerJournal
    PATH = "/v1/prayer_journal/{id}/"
...
class PrayerJournalDestroyAPITest(APITestCase):
    MODEL = PrayerJournal
    PATH = "/v1/prayer_journal/{id}/"
