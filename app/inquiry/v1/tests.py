...
class InquiryListAPITest(APITestCase):
    MODEL = Inquiry
    PATH = "/v1/inquiry/"
...
class InquiryRetrieveAPITest(APITestCase):
    MODEL = Inquiry
    PATH = "/v1/inquiry/{id}/"
...
class InquiryUpdateAPITest(APITestCase):
    MODEL = Inquiry
    PATH = "/v1/inquiry/{id}/"
...
class InquiryDestroyAPITest(APITestCase):
    MODEL = Inquiry
    PATH = "/v1/inquiry/{id}/"
