...
class TestimonyJournalListAPITest(APITestCase):
...
class TestimonyJournalCreateAPITest(APITestCase):
    MODEL = TestimonyJournal
    PATH = "/v1/testimony_journal/"
...
class TestimonyJournalRetrieveAPITest(APITestCase):
    MODEL = TestimonyJournal
    PATH = "/v1/testimony_journal/{id}/"
...
class TestimonyJournalUpdateAPITest(APITestCase):
    MODEL = TestimonyJournal
    PATH = "/v1/testimony_journal/{id}/"
...
class TestimonyJournalDestroyAPITest(APITestCase):
    MODEL = TestimonyJournal
    PATH = "/v1/testimony_journal/{id}/"
