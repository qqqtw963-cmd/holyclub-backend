...
class BibleVersionListAPITest(APITestCase):
    MODEL = BibleVersion
    PATH = "/v1/bible_version/"
...
class BibleVersionCreateAPITest(APITestCase):
    MODEL = BibleVersion
    PATH = "/v1/bible_version/"
...
class BibleVersionRetrieveAPITest(APITestCase):
    MODEL = BibleVersion
    PATH = "/v1/bible_version/{id}/"
...
class BibleVersionUpdateAPITest(APITestCase):
    MODEL = BibleVersion
    PATH = "/v1/bible_version/{id}/"
...
class BibleVersionDestroyAPITest(APITestCase):
    MODEL = BibleVersion
    PATH = "/v1/bible_version/{id}/"
