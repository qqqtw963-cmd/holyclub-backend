...
class NotificationCreateAPITest(APITestCase):
    MODEL = Notification
    PATH = "/v1/notification/"
...
class NotificationRetrieveAPITest(APITestCase):
    MODEL = Notification
...
class NotificationUpdateAPITest(APITestCase):
    MODEL = Notification
    PATH = "/v1/notification/{id}/"
...
class NotificationDestroyAPITest(APITestCase):
    MODEL = Notification
    PATH = "/v1/notification/{id}/"
