...
class TermsOfServiceListAPITest(APITestCase):
    MODEL = TermsOfService
    PATH = "/v1/terms_of_service/"
...
class TermsOfServiceCreateAPITest(APITestCase):
    MODEL = TermsOfService
    PATH = "/v1/terms_of_service/"
...
class TermsOfServiceRetrieveAPITest(APITestCase):
    MODEL = TermsOfService
    PATH = "/v1/terms_of_service/{id}/"
...
class TermsOfServiceUpdateAPITest(APITestCase):
    MODEL = TermsOfService
    PATH = "/v1/terms_of_service/{id}/"
...
class TermsOfServiceDestroyAPITest(APITestCase):
    MODEL = TermsOfService
    PATH = "/v1/terms_of_service/{id}/"
