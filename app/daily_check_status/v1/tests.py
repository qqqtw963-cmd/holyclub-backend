...
class DailyCheckStatusListAPITest(APITestCase):
    MODEL = DailyCheckStatus
    PATH = "/v1/daily_check_status/"
...
class DailyCheckStatusCreateAPITest(APITestCase):
    MODEL = DailyCheckStatus
    PATH = "/v1/daily_check_status/"
...
class DailyCheckStatusRetrieveAPITest(APITestCase):
    MODEL = DailyCheckStatus
    PATH = "/v1/daily_check_status/{id}/"
...
class DailyCheckStatusUpdateAPITest(APITestCase):
    MODEL = DailyCheckStatus
    PATH = "/v1/daily_check_status/{id}/"
...
class DailyCheckStatusDestroyAPITest(APITestCase):
    MODEL = DailyCheckStatus
    PATH = "/v1/daily_check_status/{id}/"
