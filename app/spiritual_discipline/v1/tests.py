...
class SpiritualDisciplineListAPITest(APITestCase):
    MODEL = SpiritualDiscipline
    PATH = "/v1/spiritual_discipline/"
...
class SpiritualDisciplineCreateAPITest(APITestCase):
    MODEL = SpiritualDiscipline
    PATH = "/v1/spiritual_discipline/"
...
class SpiritualDisciplineRetrieveAPITest(APITestCase):
    MODEL = SpiritualDiscipline
    PATH = "/v1/spiritual_discipline/{id}/"
...
class SpiritualDisciplineUpdateAPITest(APITestCase):
    MODEL = SpiritualDiscipline
    PATH = "/v1/spiritual_discipline/{id}/"
...
class SpiritualDisciplineDestroyAPITest(APITestCase):
    MODEL = SpiritualDiscipline
    PATH = "/v1/spiritual_discipline/{id}/"
