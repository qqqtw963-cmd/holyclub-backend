...
class PrayerBgmTrackListAPITest(APITestCase):
    MODEL = PrayerBgmTrack
    PATH = "/v1/prayer_bgm_track/"
...
class PrayerBgmTrackCreateAPITest(APITestCase):
    MODEL = PrayerBgmTrack
    PATH = "/v1/prayer_bgm_track/"
...
class PrayerBgmTrackRetrieveAPITest(APITestCase):
    MODEL = PrayerBgmTrack
    PATH = "/v1/prayer_bgm_track/{id}/"
...
class PrayerBgmTrackUpdateAPITest(APITestCase):
    MODEL = PrayerBgmTrack
    PATH = "/v1/prayer_bgm_track/{id}/"
...
class PrayerBgmTrackDestroyAPITest(APITestCase):
    MODEL = PrayerBgmTrack
    PATH = "/v1/prayer_bgm_track/{id}/"
