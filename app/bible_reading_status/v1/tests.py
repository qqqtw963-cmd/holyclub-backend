...
class BibleReadingStatusListAPITest(APITestCase):
    MODEL = BibleReadingStatus
    PATH = "/v1/bible_reading_status/"
...
class BibleReadingStatusCreateAPITest(APITestCase):
    MODEL = BibleReadingStatus
    PATH = "/v1/bible_reading_status/"
...
class BibleReadingStatusRetrieveAPITest(APITestCase):
    MODEL = BibleReadingStatus
    PATH = "/v1/bible_reading_status/{id}/"
...
class BibleReadingStatusUpdateAPITest(APITestCase):
    MODEL = BibleReadingStatus
    PATH = "/v1/bible_reading_status/{id}/"
...
class BibleReadingStatusDestroyAPITest(APITestCase):
    MODEL = BibleReadingStatus
    PATH = "/v1/bible_reading_status/{id}/"
