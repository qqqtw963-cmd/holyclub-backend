...
class PrivacyPolicyListAPITest(APITestCase):
    MODEL = PrivacyPolicy
    PATH = "/v1/privacy_policy/"
...
class PrivacyPolicyCreateAPITest(APITestCase):
    MODEL = PrivacyPolicy
    PATH = "/v1/privacy_policy/"
...
class PrivacyPolicyRetrieveAPITest(APITestCase):
    MODEL = PrivacyPolicy
    PATH = "/v1/privacy_policy/{id}/"
...
class PrivacyPolicyUpdateAPITest(APITestCase):
    MODEL = PrivacyPolicy
    PATH = "/v1/privacy_policy/{id}/"
...
class PrivacyPolicyDestroyAPITest(APITestCase):
    MODEL = PrivacyPolicy
    PATH = "/v1/privacy_policy/{id}/"
