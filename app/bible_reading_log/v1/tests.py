...
class BibleReadingLogListAPITest(APITestCase):
    MODEL = BibleReadingLog
    PATH = "/v1/bible_reading_log/"
...
class BibleReadingLogCreateAPITest(APITestCase):
    MODEL = BibleReadingLog
    PATH = "/v1/bible_reading_log/"
...
class BibleReadingLogRetrieveAPITest(APITestCase):
    MODEL = BibleReadingLog
    PATH = "/v1/bible_reading_log/{id}/"
...
class BibleReadingLogUpdateAPITest(APITestCase):
    MODEL = BibleReadingLog
    PATH = "/v1/bible_reading_log/{id}/"
...
class BibleReadingLogDestroyAPITest(APITestCase):
    MODEL = BibleReadingLog
    PATH = "/v1/bible_reading_log/{id}/"
