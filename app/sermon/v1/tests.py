...
from app.sermon.models import Sermon
from app.user.models import User


class SermonListAPITest(APITestCase):
    MODEL = Sermon
    PATH = "/v1/sermon/"
...
class SermonCreateAPITest(APITestCase):
    MODEL = Sermon
    PATH = "/v1/sermon/"
...
class SermonRetrieveAPITest(APITestCase):
    MODEL = Sermon
    PATH = "/v1/sermon/{id}/"
...
class SermonUpdateAPITest(APITestCase):
    MODEL = Sermon
    PATH = "/v1/sermon/{id}/"
...
class SermonDestroyAPITest(APITestCase):
    MODEL = Sermon
    PATH = "/v1/sermon/{id}/"
