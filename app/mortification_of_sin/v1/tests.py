...
class MortificationOfSinListAPITest(APITestCase):
    MODEL = MortificationOfSin
    PATH = "/v1/mortification_of_sin/"
...
class MortificationOfSinCreateAPITest(APITestCase):
    MODEL = MortificationOfSin
    PATH = "/v1/mortification_of_sin/"
...
class MortificationOfSinRetrieveAPITest(APITestCase):
    MODEL = MortificationOfSin
    PATH = "/v1/mortification_of_sin/{id}/"
...
class MortificationOfSinUpdateAPITest(APITestCase):
    MODEL = MortificationOfSin
    PATH = "/v1/mortification_of_sin/{id}/"
...
class MortificationOfSinDestroyAPITest(APITestCase):
    MODEL = MortificationOfSin
    PATH = "/v1/mortification_of_sin/{id}/"
