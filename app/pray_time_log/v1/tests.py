...
class PrayTimeLogListAPITest(APITestCase):
    MODEL = PrayTimeLog
    PATH = "/v1/pray_time_log/"
...
class PrayTimeLogCreateAPITest(APITestCase):
    MODEL = PrayTimeLog
    PATH = "/v1/pray_time_log/"
...
class PrayTimeLogRetrieveAPITest(APITestCase):
    MODEL = PrayTimeLog
    PATH = "/v1/pray_time_log/{id}/"
...
class PrayTimeLogUpdateAPITest(APITestCase):
    MODEL = PrayTimeLog
    PATH = "/v1/pray_time_log/{id}/"
...
class PrayTimeLogDestroyAPITest(APITestCase):
    MODEL = PrayTimeLog
    PATH = "/v1/pray_time_log/{id}/"
