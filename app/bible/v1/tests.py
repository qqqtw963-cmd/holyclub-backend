...
class BibleListAPITest(APITestCase):
    MODEL = Bible
    PATH = "/v1/bible/"
...
class BibleCreateAPITest(APITestCase):
    MODEL = Bible
    PATH = "/v1/bible/"
...
class BibleRetrieveAPITest(APITestCase):
    MODEL = Bible
    PATH = "/v1/bible/{id}/"
...
class BibleUpdateAPITest(APITestCase):
    MODEL = Bible
    PATH = "/v1/bible/{id}/"
...
class BibleDestroyAPITest(APITestCase):
    MODEL = Bible
    PATH = "/v1/bible/{id}/"
