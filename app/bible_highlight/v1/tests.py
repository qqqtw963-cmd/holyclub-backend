...
class BibleHighlightListAPITest(APITestCase):
    MODEL = BibleHighlight
    PATH = "/v1/bible_highlight/"
...
class BibleHighlightCreateAPITest(APITestCase):
    MODEL = BibleHighlight
    PATH = "/v1/bible_highlight/"
...
class BibleHighlightRetrieveAPITest(APITestCase):
    MODEL = BibleHighlight
    PATH = "/v1/bible_highlight/{id}/"
...
class BibleHighlightUpdateAPITest(APITestCase):
    MODEL = BibleHighlight
    PATH = "/v1/bible_highlight/{id}/"
...
class BibleHighlightDestroyAPITest(APITestCase):
    MODEL = BibleHighlight
    PATH = "/v1/bible_highlight/{id}/"
